...
public class LoginTest
{
	...
	public void login()
	{
		...
		wait.Until(driver => driver.FindElement((By.CssSelector(".bi-person-circle"))));
		...
		Assert.That(driver.FindElement(By.CssSelector(".alert")).Text, Is.EqualTo("Uspješno ste prijavljeni. Preusmjereni ste na poèetnu stranicu."));
	}
}
